package com.alienspacebunny.testmetrics.junit;
    ...
    public static InputStream createEscapedJUnitInputStream(InputStream stream) throws IOException {
        try (stream) {
            ...
            if (systemOutStartIndex > 0 && systemOutEndIndex > 0) {
                ...
                contents = contents.substring(0, systemOutStartIndex) + StringEscapeUtils.escapeXml10(contents.substring(systemOutStartIndex, systemOutEndIndex)) + contents.substring(systemOutEndIndex);
            }
            ...
            if (systemErrStartIndex > 0 && systemErrEndIndex > 0) {
                ...
                contents = contents.substring(0, systemErrStartIndex) + StringEscapeUtils.escapeXml10(contents.substring(systemErrStartIndex, systemErrEndIndex)) + contents.substring(systemErrEndIndex);
            }
